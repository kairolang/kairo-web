 ...
 *
 * Generates /public/llms-partial.txt from the Astro content collection.
...
const OUTPUT_FILE  = 'public/llms-partial.txt';
...
function sortDocs(files, baseDir) {
  ...
  for (const f of files) {
    ...
    else if (!rel.startsWith('library/') && !rel.startsWith('toolchain/') && !rel.startsWith('examples/')) topLevel.push(f);
